...
export default function Photography() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-purple-900">
      <div
        ref={ref}
        className="min-h-[200vh] max-h-fit py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
      >
        <Header />
        <motion.div
          style={{
          ...
          <div className="space-y-6 text-gray-300">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <a href="tel:+14693890421" className="hover:text-white">
                  +1 (469) 389 0421
                </a>
              </div>
              <div className="flex items-center gap-4">
