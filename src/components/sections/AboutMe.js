          ...
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300 sm:max-w-md lg:max-w-none">
                ...
                doing <b>photography and videography</b> in my free time. I'm 21
                and currently a student at the University of Texas at Dallas. I
                have worked on a variety of mobile applications to web
                applications and I am always looking for new opportunities to
                learn and grow!
              </p>
